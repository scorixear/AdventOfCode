...
hand_offset = [0, 5*14+1, 5*14*2 + 2, 5*14*2 + 3, 5*14*3+3, 5*14*4+4, 5*14*5+5]
...
def get_highest_groups(hand):
    ...
    for c in hand:
        ...
        if c in card_apperance:
            ...
            card_apperance[c] = 1
        if card_apperance[c] > highest_hit:
    ...
    return highest_hit, second_highest_hit, card_values
...
def compare_cards(card1, card2):
    ...
    if highest_hit1 > highest_hit2:
        return 1
    elif highest_hit1 < highest_hit2:
        return -1
    elif second_highest_hit1 > second_highest_hit2:
        return 1
    elif second_highest_hit1 < second_highest_hit2:
        return -1
    else:
