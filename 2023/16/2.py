...
def traverse_light(grid: list[str], start: Light) -> int:
...
def main():
    ...
    for y in range(len(lines)):
        max_enlightened = max(max_enlightened, traverse_light(lines, Light(-1, y, 1, 0)))
        max_enlightened = max(max_enlightened, traverse_light(lines, Light(len(lines[0]), y, -1, 0)))
    for x in range(len(lines)):
        max_enlightened = max(max_enlightened, traverse_light(lines, Light(x, -1, 0, 1)))
        max_enlightened = max(max_enlightened, traverse_light(lines, Light(x, len(lines), 0, -1)))
